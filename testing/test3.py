...
if choice == '1':
    ...
    # FIXED: Simplified format selector with reliable merging
    ydl_opts = {
    'format': f'bestvideo[height<={chosen_res}]+bestaudio',
    'outtmpl': os.path.join(folder, '%(title)s.%(ext)s'),
    'merge_output_format': 'mp4',  # Ensures merging happens
    'ffmpeg_location': None,  # Use system default FFmpeg
    }
